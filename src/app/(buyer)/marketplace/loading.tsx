  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="mt-2 h-4 w-72 rounded-md bg-white/[0.04] animate-pulse" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="rounded-xl border border-white/[0.06] bg-[#002a47] p-4 space-y-3 animate-pulse">
